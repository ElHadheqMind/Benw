...
class AppColors {
  ...
  // Benw Education brand gradient colors
  ...
  // Benw Tutor brand colors
  static const Color BenwStart = Color(0xFF10B981);
  static const Color BenwMid = Color(0xFF3B82F6);
  static const Color BenwEnd = Color(0xFF8B5CF6);
  ...
  static const LinearGradient BenwGradient = LinearGradient(
    colors: [BenwStart, BenwMid, BenwEnd],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );

  static const LinearGradient BenwGradientHorizontal = LinearGradient(
    colors: [BenwStart, BenwMid, BenwEnd],
